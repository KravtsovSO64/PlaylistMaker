...
import com.practicum.playlistmaker.data.repositories.media.PlaylistRepositoryImpl
...
val repositoryModule = module {
    ...
    factory<PlaylistRepository> { PlaylistRepositoryImpl(androidContext(), get(), get()) }
}